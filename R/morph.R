...
#'
#' In `morph_doc()`, global changes can be defined. Then, the user must supply
#' one `s* = morph_sec(...)` arguments, where `*` corresponds to the section
...
#'  the `morph_doc()`'s argument. Can be overridden by passing a `head1`
#'  argument.
#' @param end To set the default value for `e()`'s' and `div()`'s `end`
#'  argument. The default value for `morph_sec` is whatever was passed to
...
#'
#' @export
morph_doc <- function(sections, ..., head_lv = 2, end = "pbr") {
...
#' @rdname morphing
#' @export
morph_sec <- function(..., head_lv = NULL, end = NULL) {
